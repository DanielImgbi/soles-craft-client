...
const Login = () => {
    ...
    const { register, handleSubmit, reset, formState: { errors } } = useForm<LoginT>({
        defaultValues: {
            email: '',
            password: ''
        },
            ...
            >
                ...
                <Container className="w-full h-4/6 flex flex-col gap-10 items-center md:gap-7" >
                    ...
                    <Container className='flex justify-center p-2 w-5/6'>
                        <button type="submit" className="bg-yellow-600 text-white font-semibold py-4 px-12 rounded-xl md:py-2">Login</button>
                    </Container>
                </Container>
            </form>
        </Container>
